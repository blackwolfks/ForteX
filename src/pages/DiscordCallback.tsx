    ...
    const handleCallback = async () => {
      try {
        ...
        toast({
          ...
          description: "Sie wurden erfolgreich mit Discord angemeldet.",
        });
        
        navigate("/dashboard");
      } catch (err) {
        console.error("Discord Auth Fehler:", err);
        setError("Bei der Anmeldung mit Discord ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.");
        setIsLoading(false);
      }
    };
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md shadow-medium">
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            <h2 className="text-xl font-medium">Anmeldung mit Discord</h2>
