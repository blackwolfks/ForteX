    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-2">
        ...
        <Button
          ...
          className="w-full bg-gray-800 border-gray-700 text-gray-200 hover:bg-gray-700 focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 focus:ring-offset-gray-900"
        >
          {isLoading === "cfx" ? (
            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
          ) : (
            <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20Z" fill="#0ab4a8"/>
              <path d="M15 8H9V16H15V8Z" fill="#0ab4a8"/>
            </svg>
          )}
          Mit CFX anmelden
        </Button>
