...
import { RefreshCw, Save, Trash2, Copy, Check, Shield, Server } from "lucide-react";
              ...
              {license.script_file && (
                <Button 
                  ...
                  onClick={() => {
                    ...
                    onUpdateScript(license.id, license.script_name, codeElement.value, license.server_ip, license.aktiv);
                  }}
                >
